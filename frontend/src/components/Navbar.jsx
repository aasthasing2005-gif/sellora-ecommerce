    ...
    <header className='fixed-nav-bar w-nav'>
      <nav className='max-w-screen-2xl mx-auto px-4 flex justify-between items-center'>
        ...
        <div className='nav__logo'>
          <Link to='/'>Sellora <span>.</span></Link>
        </div>
        ...
        <div className='nav__icons relative'>
          ...
          <span>
            <button onClick={handleCartToggle} className='hover:text-red-400'>
              <i className="ri-shopping-bag-line"></i>
              <sup className='text-sm inline-block px-1.5 text-white rounded-full bg-rose-400 text-center align-middle leading-none'>{products.length}</sup>
            </button>
          </span>
          <span>
            {
